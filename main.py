...
max_result = 599 # maximum query results from arXiv API for each keyword
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/LiXin97/Daily_ArXiv) page for a better reading experience and more papers.**\n\n")
